...
# The format of |config_text| is spade(norm)(kernel_size), where
# (norm) specifies the type of parameter-free normalization.
#       (e.g. syncbatch, batch, instance)
# (kernel_size) specifies the size of kernel in the SPADE module (e.g. 3x3)
...
class SPADE(nn.Module):
    ...
    def forward(self, x, segmap):
        ...
        actv = self.shared_layer(segmap)
        gamma = self.gamma_layer(actv)
        beta = self.beta_layer(actv)
